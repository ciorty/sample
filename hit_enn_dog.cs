...
public class hit_enn_dog : MonoBehaviour
{	
	public float inPush;
	public int once;
    public int once_rel;
    ...
    void Update()
    {
        if(inert == 1)
        {
            ...
            transform.parent.gameObject.GetComponent<zbb_dog>().inert = 1;
            if (mesh_animated)
            {
            ...
            if(once_oase == 0)
            {
                ...
                ost2.transform.Find("ego_mesh").GetComponent<Renderer>().material.mainTexture = transform.parent.gameObject.GetComponent<zbb_dog>().myT;
